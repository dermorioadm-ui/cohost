...
export function LegalUpsell() {
  ...
  return <aside className="mt-8 rounded-3xl border border-border p-6 text-left" aria-label="Assistência jurídica opcional">
    ...
    <p className="rotulo mt-4 text-primary">Opcional · contratação separada</p>
    <h2 className="mt-2 text-2xl tracking-titulo">E quando o problema pede um advogado?</h2>
    ...
    <Button asChild variant="outline" className="mt-5 w-full"><Link to="/juridico?origem=pos-compra">Conhecer condições e contratar</Link></Button>
